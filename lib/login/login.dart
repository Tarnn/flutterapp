  ...
  Container _buildSocialBtnsRow() {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildSocialBtn(() => print("tapped FB Social button..."),
              AssetImage('assets/images/png/001-facebook.png')),
          _buildSocialBtn(() => print("tapped Google Social button..."),
              AssetImage('assets/images/png/002-google.png')),
        ],
      ),
    );
  }
  ...
  Column _buildSignInWithText() {
    return Column(
      children: <Widget>[
        ...
        Text('Sign in with', style: Constants.kLabelStyle)
      ],
    );
  }
